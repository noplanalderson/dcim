...
<html lang="en">
    <head>
        ...
        <title><?= $this->app['app_title_short'];?> - Timeline Device <?= $device['hostname'];?></title>
        ...
        <link href="<?= site_url();?>assets/vendors/timeline-master/dist/css/timeline.min.css" rel="stylesheet" />
        <!-- CSS file -->
