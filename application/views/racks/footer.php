        ...
        $('#racks').DataTable({
            ...
            buttons: [
                ...
                },
                {
                    extend: 'excelHtml5',
                    pageSize: 'Legal',
                    title: "Daftar Perangkat di <?= $rack_title;?> Pemerintah Kota Tangerang",
                    exportOptions: {
                        columns: ':visible'
                    }
                },
                {
                    ...
                    customize : function(doc) 
                    {
                        doc.content.splice(0, 1, {
                          text: [
                            {
                                text: "Daftar Perangkat di <?= $rack_title;?> Pemerintah Kota Tangerang \n\n",
                                fontSize: 14,
                                alignment: 'center'
                            }, 
                            {
                                text: "Total Perangkat di <?= $rack_title.' : '.$count;?> Unit\n\n\n",
                                fontSize: 9,
                                alignment: 'left'
                            }
                          ]
                        ...
                        var tr = $('#racks tbody tr:first-child');
                        var trWidth = $(tr).width();

                        var length = $('#racks tbody tr:first-child td').length;

                        $('#racks').find('tbody tr:first-child td').each(function()
                        {
