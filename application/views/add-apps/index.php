                    ...
                    <?= form_open('', 'method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" accept-charset="utf-8"');?>
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <input id="url" name="url" class="form-control" type="url" placeholder="http(s)://" value="<?= show_value('url');?>" required />
                        </div>
                      </div>
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <textarea required="required" name="notes" class="form-control" data-parsley-length="[5, 100]"><?= show_value('notes');?></textarea>
                        </div>
                      </div>
