...
<html lang="en">
    <head>
        ...
        <title><?= $this->app['site_title_short'];?> - <?= get_title_by_uri();?></title>
        ...
        <!-- Bootstrap Select -->
        <link href="<?= site_url();?>assets/vendors/bootstrap-select/dist/css/bootstrap-select.css" rel="stylesheet" type="text/css">
        <!-- JQuery UI -->
        <link href="https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/themes/smoothness/jquery-ui.css" rel="stylesheet" type="text/css">
        <link href="<?= site_url();?>assets/vendors/datetimepicker/dist/jquery-ui-timepicker-addon.css" rel="stylesheet" media="all" type="text/css" />
        <!-- ICheck -->
