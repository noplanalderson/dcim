                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      ...
                      <br/><br/>
                      <?= form_open_multipart('add-device/add', 'method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
                        ...
                        <div id="myTabContent" class="tab-content">
                          <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                              ...
                              <div class="col-md-3 col-sm-3 col-xs-12">
                                <select id="device-group" class="form-control" name="device_group" required />
                                  ...
                                  <option count="<?= generate_number('tb_devices', 'group_code', $group['group_code']);?>"  value="<?= $group['group_code'];?>" <?php if($group['group_code'] == show_value('device_group')):?>selected<?php endif;?>>
                                  <?= $group['group_label'];?></option>
                                  <?php endforeach;?>
                                </select>
                              </div>
                              <div class="col-md-5 col-sm-5 col-xs-12">
                                <input id="device_number" name="device_number" class="form-control" placeholder="Device Number" type="text" value="<?= show_value('device_number');?>" data-parsley-type="digits" required />
                              </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                              ...
                              <div class="col-md-8 col-sm-8 col-xs-12">
                                <select id="manufacture" class="form-control manufacture col-md-6 col-xs-12" name="manufacture" required />
                                  ...
                                  <optgroup label='<?= ucwords($group['group_label']);?>'>
                                    ...
                                    ?>
                                    <option value="<?= $manu['dev_manufacture_id'];?>" <?php if($manu['dev_manufacture_id'] == show_value('manufacture')):?>selected<?php endif;?>>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                              ...
                              <div class="col-md-8 col-sm-8 col-xs-12">
                                <input id="processor" type="text" name="processor_type" class="form-control" value="<?= show_value('processor_type');?>" placeholder="Processor" data-parsley-length="[5, 50]">
                              </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                              ...
                              <div class="col-md-8 col-sm-8 col-xs-12">
                                <select id="model" class="form-control model col-md-6 col-xs-12" name="model" required/>
                                  ...
                                  <optgroup label='<?= ucwords($manu['dev_manufacture']);?>'>
                                    ...
                                    ?>
                                    <option value="<?= $model['dev_model_id'];?>" <?php if($model['dev_model_id'] == show_value('model')):?>selected<?php endif;?>>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                              ...
                              <div class="col-md-8 col-sm-8 col-xs-12">
                                <input id="cores" name="cores" class="form-control" type="text" value="<?= show_value('cores');?>" placeholder="0" min="1" max="128" data-parsley-validation-threshold="1" data-parsley-trigger="keyup" data-parsley-type="digits">
                              </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                              ...
                              <div class="col-md-8 col-sm-8 col-xs-12">
                                <input id="memory_model" type="text" class="tags model-hw form-control" name="memory_model" value="<?= show_value('memory_model');?>">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                              ...
                              <div class="col-md-8 col-sm-8 col-xs-12">
                                <input id="mem_cap" name="mem_cap" class="size-hw form-control col-md-6 col-xs-6" type="text" value="<?= show_value('mem_cap');?>" placeholder="0" data-parsley-validation-threshold="1" data-parsley-trigger="keyup" data-parsley-pattern="^[0-9,]+$">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                              ...
                              <div class="col-md-8 col-sm-8 col-xs-12">
                                <input id="hdd_cap" name="hdd_cap" class="form-control size-hw" type="text" value="<?= show_value('hdd_cap');?>" placeholder="0" data-parsley-validation-threshold="1" data-parsley-trigger="keyup" data-parsley-pattern="^[0-9,]+$">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                              ...
                              <div class="col-md-8 col-sm-8 col-xs-12">
                                <input id="hdd_model" type="text" class="tags model-hw form-control" name="hdd_model" value="<?= show_value('hdd_model');?>">
                                <small>Separate by comma if more than one model</small>
                              </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                          ...
                          <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                              ...
                              <div class="col-md-8 col-sm-8 col-xs-12">
                                <input id="location" name="location" class="form-control" type="text" value="<?= show_value('location');?>" placeholder="Lokasi Perangkat" data-parsley-pattern="^[a-zA-Z0-9\s]+$" data-parsley-length="[3, 50]" required>
                              </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                              <label for="rack" class="control-label col-md-3 col-sm-3 col-xs-12">Rack Number</label>
                              <div class="col-md-8 col-sm-8 col-xs-12">
                                <input id="rack" name="rack" class="form-control col-md-6 col-xs-6" type="text" value="<?= show_value('rack');?>" placeholder="0" max="100" data-parsley-trigger="keyup" data-parsley-type="digits" required>
                                ...
                                <select id="procurement" class="form-control col-md-6 col-xs-6" name="procurement" required>
                                  <option value="">Choose Year..</option>
                                    <?php for($i=2002; $i<=2002+48; $i+=1):?>>
                                      <option value="<?= $i; ?>" <?php if($i == show_value('procurement')):?>selected<?php endif;?>><?= $i; ?></option>
                                    <?php endfor;?>
                                </select>
                              </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                              ...
                              <div class="col-md-8 col-sm-8 col-xs-12">
                                <input id="owner" class=" form-control col-md-6 col-xs-6" type="text" name="owner" value="<?= show_value('owner');?>" placeholder="Device Owner" data-parsley-pattern="^[a-zA-Z0-9\s-.]+$" data-parsley-length="[3, 50]" required>
                              </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group">
