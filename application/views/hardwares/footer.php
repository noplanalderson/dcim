        ...
        $('#hardwares').DataTable({
            ...
            buttons: [
                ...
                },
                {
                    extend: 'excelHtml5',
                    pageSize: 'Legal',
                    title: "Daftar Hardware <?= ucwords($hw_group);?> Pemerintah Kota Tangerang",
                    exportOptions: {
                        columns: ':visible'
                    }
                },
                {
                    ...
                    customize : function(doc) 
                    {
                        doc.content.splice(0, 1, {
                          text: [
                            {
                                text: "Daftar Hardware <?= ucwords($hw_group);?> Pemerintah Kota Tangerang \n\n",
                                fontSize: 14,
                                alignment: 'center'
                            }, 
                            {
                                text: "Total <?= ucwords($hw_group).' : '.$counthw;?> Unit\n\n\n",
                                fontSize: 9,
                                alignment: 'left'
                            }
                          ]
