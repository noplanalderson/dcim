                    ...
                    <?= form_open('', 'method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" accept-charset="utf-8"');?>
                          ...
                          <div class="col-md-8 col-sm-8 col-xs-12">
                            <select id="device" class="form-control col-md-6 col-xs-12" name="device" required/>
                              ...
                              <?php foreach ($devices as $device) :?>
                                ...
                                <option value="<?= $device['device_code'];?>" <?php if($device['device_code'] == show_value('device')):?>selected<?php endif;?>>
                                  <?= $device['hostname'];?>
                                </option>
                      ...
                      <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                          ...
                          <div class="col-md-8 col-sm-8 col-xs-12">
                            <input id="hdd_cap" name="hdd_cap" class="form-control col-md-6 col-xs-6" type="text" value="<?= show_value('hdd_cap');?>" placeholder="0" data-parsley-trigger="keyup" data-parsley-type="digits">
                          </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                          <label for="mem_cap" class="control-label col-md-3 col-sm-3 col-xs-12">Memory Capacity (GB)</label>
                          <div class="col-md-8 col-sm-8 col-xs-12">
                            <input id="mem_cap" name="mem_cap" class="form-control col-md-6 col-xs-6" type="text" value="<?= show_value('mem_cap');?>" placeholder="0" data-parsley-trigger="keyup" data-parsley-type="digits">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                          ...
                          <div class="col-md-8 col-sm-8 col-xs-12">
                            <input id="cores" name="cores" class="form-control col-md-6 col-xs-6" type="text" value="<?= show_value('cores');?>" placeholder="0" data-parsley-trigger="keyup" data-parsley-type="digits">
                          </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="textarea">Notes</label>
                          <div class="col-md-8 col-sm-8 col-xs-12">
                            <textarea name="notes" class="form-control" data-parsley-length="[5, 100]"><?= show_value('notes');?></textarea>
                          </div>
                        </div>
                      </div>
