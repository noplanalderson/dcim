...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?= site_url();?>assets/vendors/easyautocomplete/easy-autocomplete.min.css">
    <!-- Additional CSS Themes file - not required-->
    <link rel="stylesheet" href="<?= site_url();?>assets/vendors/easyautocomplete/easy-autocomplete.themes.min.css">
    <!-- Datatables -->
