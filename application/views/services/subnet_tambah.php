                    ...
                    <?= form_open('', 'method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"');?>
                        ...
                        <div class="col-md-1 col-sm-2 col-xs-12">
                          <select id="d" class="form-control col-sm-3 col-xs-6" name="d" required>
                            ...
                            <?php
                              ...
                              for ($i = $y; $i < count($x); $i++) :
                            ?>
                              <option value="<?= $x[$i];?>" <?php  if(show_value('d') == $x[$i]):?>selected<?php endif;?>><?= $x[$i];?></option>";
                              
                            <?php endfor; ?>
                          </select>
                        </div>
                        <div class="col-md-2 col-sm-1 col-xs-12">
                          <input type="number" id="vlan" class="form-control col-sm-3 col-xs-6" name="vlan" placeholder="VLAN ID" value="<?= show_value('vlan');?>" required>
                        </div>
                        <div class="col-md-2 col-sm-1 col-xs-12">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <textarea required="required" name="label" class="form-control col-md-7 col-xs-12" data-parsley-length="[5, 100]"><?= show_value('label');?></textarea>
                        </div>
                      </div>   
