                    ...
                    <?= form_open('', 'method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" accept-charset="utf-8"');?>
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <input id="wifi_ssid" name="wifi_ssid" class="form-control" type="text" placeholder="SSID Wifi" value="<?= $wifi['wifi_ssid'];?>" required>
                        </div>
                      </div>
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                        <label for="wifi_user" class="control-label col-md-3 col-sm-3 col-xs-12">Username</label>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <input id="wifi_user" name="wifi_user" class="form-control" type="text" placeholder="Username" value="<?= $wifi['wifi_user'];?>">
                        </div>
                      </div>
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                        <label for="wifi_password" class="control-label col-md-3 col-sm-3 col-xs-12">Password Wifi</label>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <input id="wifi_password" name="wifi_password" class="form-control" type="password" placeholder="********" value="<?= $wifi['wifi_password'];?>">
                        </div>
                      </div>
